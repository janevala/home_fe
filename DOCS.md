# Home News App System Architecture
...
- **Database**: PostgreSQL (`postgres://postgres:1234@192.168.1.151:5432/homebedb?sslmode=disable`)
- **Security**: 
  - All endpoints require `code=123` query parameter for authentication
  - CORS enabled globally

### Data Layer
- **Database**: PostgreSQL on external host (`192.168.1.151`)
- **Connection String**: `postgres://postgres:1234@192.168.1.151:5432/homebedb?sslmode=disable`
...
DATABASE_URL=postgres://postgres:1234@192.168.1.151:5432/homebedb?sslmode=disable
```
...
|---------|--------------|---------------|----------|
| Frontend (Flutter Web) | 7070 | 7070 | HTTPS |
| Backend (API) | 7071 | 7071 | HTTPS |

### Network Communication
```
Frontend Container ──(HTTP API calls──)──► Backend Container
      │                                                    │
      ▼                                                    ▼
┌──────────────┐                              ┌─────────────────┐
│              │ ─── Postgres DB ───►         │                 │
│               │   192.168.1.151:5432        │   Database     │
│               │                              │                 │
└──────────────┘                              └─────────────────┘
...
|----------|----------------|---------------|-------------|
| ENV | release/debug | debug/release | Build target |
| APP_API | http://api-host:7071 | - | Backend endpoint |
...
- **Developer**: janevala (Flutter, Kotlin, Golang specialist)
...
*Document generated by Mr.Bot 🤖 on 2026-03-24*
